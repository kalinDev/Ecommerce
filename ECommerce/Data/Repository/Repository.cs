...
namespace ECommerce.Data.Repository {
  public class Repository<TEntity> : IRepository<TEntity>
    ...
    FindByIdAsync(Guid id) => await DbSet.FindAsync(id);

    public async Task<List<TEntity>> FindAsync() => await DbSet.ToListAsync();
    ...
    AnyAsync(Guid id) => await DbSet.AnyAsync(e => e.Id == id);
